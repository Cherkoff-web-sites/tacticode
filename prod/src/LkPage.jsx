...
function DeviceTypeIcon({ deviceName, deviceType }) {
  if (String(deviceType || "").toLowerCase() === "mobile" || /iPhone|iPad|Android|phone|tablet|mobile/i.test(deviceName)) {
    return (
  ...
  if (String(deviceType || "").toLowerCase() === "desktop" || /MSI|Katana|Laptop|Notebook|Book|Mac|Windows|Linux|PC/i.test(deviceName)) {
    return (
      <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 shrink-0" aria-hidden="true">
                        ...
                        {devices.map((device) => {
                          ...
                          return (
                            <div
                              ...
                              key={device.id}
                            >
                              <DeviceTypeIcon deviceName={device.name} deviceType={device.deviceType} />
