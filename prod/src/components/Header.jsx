    ...
    <>
      ...
      {(mobileMenuOpen || mobileMenuClosing) && (
        <div className="md:hidden fixed inset-0 z-30" aria-modal="true" role="dialog">
          ...
          <button
            type="button"
            className={`absolute top-[24px] left-[calc(272px+6.5vw)] flex items-center justify-center z-[100] mobile-menu-close-btn ${
              mobileMenuClosing ? "mobile-menu-close-btn--exiting" : "mobile-menu-close-btn--entering"
            }`}
          ...
          >
            <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <rect x="12.1445" y="12.8569" width="1.42857" height="20" rx="0.714286" transform="rotate(-45 12.1445 12.8569)" fill="#00459D"/>
              <rect x="12.8555" y="27.1431" width="1.42857" height="20" rx="0.714286" transform="rotate(-135 12.8555 27.1431)" fill="#00459D"/>
            </svg>
          </button>
